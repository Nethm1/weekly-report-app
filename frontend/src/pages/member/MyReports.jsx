  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          { label: 'Total Reports', value: reports.length, color: 'text-gray-900' },
            ...
            <div key={weekKey}>
              ...
              <div className="space-y-3">
                {grouped[weekKey].map(report => (
                  <div key={report._id} className="bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-200">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-700 line-clamp-2">{report.tasksCompleted}</p>
